...
type ShuffleDataChunk struct {
	...
	SegmentChecksum string                 `protobuf:"bytes,4,opt,name=segment_checksum,json=segmentChecksum,proto3" json:"segment_checksum,omitempty"`
	SegmentEnd      bool                   `protobuf:"varint,5,opt,name=segment_end,json=segmentEnd,proto3" json:"segment_end,omitempty"`
...
func (x *ShuffleDataChunk) GetSegmentChecksum() string {
	if x != nil {
		return x.SegmentChecksum
	}
	return ""
}

func (x *ShuffleDataChunk) GetSegmentEnd() bool {
	if x != nil {
		return x.SegmentEnd
	}
	return false
...
type TaskAssignment struct {
	...
	InputSplits      []*InputSplit          `protobuf:"bytes,16,rep,name=input_splits,json=inputSplits,proto3" json:"input_splits,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *TaskAssignment) GetInputSplits() []*InputSplit {
	if x != nil {
...
type InputSplit struct {
	...
	SplitChecksum string                 `protobuf:"bytes,4,opt,name=split_checksum,json=splitChecksum,proto3" json:"split_checksum,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InputSplit) GetByteStart() int64 {
	if x != nil {
		return x.ByteStart
	}
	return 0
...
func (x *InputSplit) GetByteEnd() int64 {
	if x != nil {
		return x.ByteEnd
	}
	return 0
...
func (x *InputSplit) GetSplitChecksum() string {
	if x != nil {
		return x.SplitChecksum
	}
	return ""
...
const file_proto_mapreduce_proto_rawDesc = "" +
	"\n" +
	"\x15proto/mapreduce.proto\x12\tmapreduce\"\xac\x01\n" +
	"\x10ShuffleDataChunk\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12!\n" +
	"\fpartition_id\x18\x02 \x01(\x05R\vpartitionId\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\x12)\n" +
	"\x10segment_checksum\x18\x04 \x01(\tR\x0fsegmentChecksum\x12\x1f\n" +
	"\vsegment_end\x18\x05 \x01(\bR\n" +
	"segmentEnd\"N\n" +
	...
	"\n" +
	"attempt_id\x18\x02 \x01(\tR\tattemptId\"\xc3\x04\n" +
	...
	"\blease_id\x18\x0f \x01(\tR\aleaseId\x128\n" +
	"\finput_splits\x18\x10 \x03(\v2\x15.mapreduce.InputSplitR\vinputSplits\"\x8a\x01\n" +
	"\n" +
	"InputSplit\x12\x1b\n" +
	"\tinput_uri\x18\x01 \x01(\tR\binputUri\x12\x1d\n" +
	"\n" +
	"byte_start\x18\x02 \x01(\x03R\tbyteStart\x12\x19\n" +
	"\bbyte_end\x18\x03 \x01(\x03R\abyteEnd\x12%\n" +
	"\x0esplit_checksum\x18\x04 \x01(\tR\rsplitChecksum\"e\n" +
