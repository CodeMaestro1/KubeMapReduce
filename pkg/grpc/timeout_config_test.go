...
func TestTimeoutConfig_CriticalPathOptimized(t *testing.T) {
	...
	timeout, _ := cfg.TimeoutForMethod("/proto.WorkerService/Heartbeat")
	...
	regTimeout, _ := cfg.TimeoutForMethod("/proto.WorkerService/Register")
